...
### ----------------------------------------------------------------------------------------------------------------------- ###
### ---                                                                                                                 --- ###
### ---   Script to simulate survey in Wider EastHerman Berwick for harbour porpoise - mean, lower and upper surfaces   --- ###
### ---                                                                                                                 --- ###
### ---                                                                                                                 --- ###
### ----------------------------------------------------------------------------------------------------------------------- ###
### ----------------------------------------------------------------------------------------------------------------------- ###
...
Herman_Berwick_utm <- st_transform(Herman_Berwick, st_crs(hp_dens))
...
hp_dens <- hp_dens[lengths(st_intersects(hp_dens, Herman_Berwick_utm)) > 0, ]
...
if(0){
  ...
  test_sim_results <- survey_simulator(reps = 5, 
                                       region_polygon = Herman_Berwick_utm, 
...
write_rds(runOutputs, path = paste0(outFolder, "_", survey_region_label, ".rds"))
