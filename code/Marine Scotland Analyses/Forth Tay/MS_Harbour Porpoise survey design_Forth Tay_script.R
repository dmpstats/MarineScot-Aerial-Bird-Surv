...
### -------------------------------------------------------------------------------------------------------------- ###
### ---                                                                                                        --- ###
### ---   Script to simulate survey in Wider Forth Tay for harbour porpoise - mean, lower and upper surfaces   --- ###
### ---                                                                                                        --- ###
### ---                                                                                                        --- ###
### -------------------------------------------------------------------------------------------------------------- ###
### -------------------------------------------------------------------------------------------------------------- ###
...
Forth_Tay_utm <- st_transform(Forth_Tay, st_crs(hp_dens))
...
hp_dens <- hp_dens[lengths(st_intersects(hp_dens, Forth_Tay_utm)) > 0, ]
...
surv_sim_parallel <- function(x, dens_surf, region_poly, spatial_units, survey_reps){
  ...
  # Select density for one species and rename the density column as 'cell_N'
  sp_dens <- dens_surf %>%
