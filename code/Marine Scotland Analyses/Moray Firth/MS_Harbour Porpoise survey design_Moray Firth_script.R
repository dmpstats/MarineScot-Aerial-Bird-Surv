...
### -------------------------------------------------------------------------------------------------------------- ###
### ---                                                                                                        --- ###
### ---     Script to simulate survey in Moray Firth for harbour porpoise - mean, lower and upper surfaces     --- ###
### ---                                                                                                        --- ###
### ---                                                                                                        --- ###
### -------------------------------------------------------------------------------------------------------------- ###
### -------------------------------------------------------------------------------------------------------------- ###
...
Moray_Firth_utm <- st_transform(Moray_Firth, st_crs(hp_dens))
...
hp_dens <- hp_dens[lengths(st_intersects(hp_dens, Moray_Firth_utm)) > 0, ]
